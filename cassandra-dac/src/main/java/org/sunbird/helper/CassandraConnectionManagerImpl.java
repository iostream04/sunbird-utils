...
public class CassandraConnectionManagerImpl implements CassandraConnectionManager {
  ...
  public Session getSession(String keyspaceName) {
    if (null == cassandraSessionMap.get(keyspaceName)) {
      throw new ProjectCommonException(ResponseCode.internalError.getErrorCode(),
          Constants.SESSION_IS_NULL + keyspaceName, ResponseCode.SERVER_ERROR.getResponseCode());
    }
  ...
  public Cluster getCluster(String keyspaceName) {
    if (null == cassandraclusterMap.get(keyspaceName)) {
      throw new ProjectCommonException(ResponseCode.internalError.getErrorCode(),
          Constants.CLUSTER_IS_NULL + keyspaceName, ResponseCode.SERVER_ERROR.getResponseCode());
    }
