...
public class CassandraTest {
  ...
  public void testCgetPropertiesValueByIdOp() {
    Response response=operation.getPropertiesValueById(cassandraKeySpace, "address", "123", JsonKey.ID,JsonKey.CITY,JsonKey.ADD_TYPE);
  ...
  public void testFgetRecordsByPropertyFrListOp() {
    ...
    list.add("123");
    list.add("321");
    Response response=operation.getRecordsByProperty(cassandraKeySpace, "address", JsonKey.ID, list);
    assertTrue(((String)((List<Map<String,Object>>)response.get("response")).get(0).get(JsonKey.ID)).equals("123"));
  }
  ...
  public void testFgetRecordsByPropertyOp() {
    Response response=operation.getRecordsByProperty(cassandraKeySpace, "address", JsonKey.ADD_TYPE, "addrType");
    assertTrue(((String)((List<Map<String,Object>>)response.get("response")).get(0).get(JsonKey.ID)).equals("123"));
  }
