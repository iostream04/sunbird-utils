...
public class SendMail {
   ...
   */
  public static boolean sendMail(String[] receipent, String subject, VelocityContext context,
      String templateName) {
   ...
   * @param ccList String
   */
  public static void sendMail(String[] receipent, String subject, VelocityContext context,
      String templateName, String[] ccList) {
    Transport transport = null;
    try {
      Session session = Session.getInstance(props, new GMailAuthenticator(userName, password));
      MimeMessage message = new MimeMessage(session);
   ...
   */
  public static void sendAttachment(String[] receipent, String mail, String subject,
      String filePath) {
    Transport transport = null;
    try {
      Session session = Session.getInstance(props, new GMailAuthenticator(userName, password));
